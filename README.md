...
---
A simple app that retrieves notes for an MP3 file and converts them to buzzer code compatible with certain buzzer libraries for the ESP32. One of the devices that uses this is the *PocketMage* by *Ashtf8*. This project was fully coded in less than 2 hours without AI.
